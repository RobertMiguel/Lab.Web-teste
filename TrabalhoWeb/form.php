            ...
            <tbody>                        
                <tr>
                  ...
                  <td style="width: 150px;"></i>
                    <select class="form-select text-secondary" name="dependentePSN" id="dependentePSI">
                      <option class="text-secondary">Selecione</option>
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-select text-secondary" name="problemaSCN" id="problemaSCI">
                        <option class="text-secondary">Selecione</option>
                        <option value="SIM" class="text-secondary">SIM</option>
                        <option value="NAO" class="text-secondary">NAO</option>
                    </select>
                ...
                <tr>
                  ...
                  <td>
                      <select class="form-select text-secondary" name="alergiasN" id="alergiasI" onchange="verifica(this.value)">
                          <option class="text-secondary">Selecione</option>
                          <option value="SIM" class="text-secondary">SIM</option>
                          <option value="NAO" class="text-secondary">NAO</option> 
                      </select>
                ...
                <tr>
                  ...
                  <td> 
                    <select class="form-select text-secondary" name="restricaoAlN" id="restricaoAlI"  onchange="verifica1(this.value)">
                      <option class="text-secondary">Selecione</option>
                      <option value="SIM" class="text-secondary">SIM</option>
                      <option value="NAO" class="text-secondary">NAO</option>
                    </select>
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-select text-secondary" name="deficienciaN" id="deficienciaI">
                      <option class="text-secondary">Selecione</option>
                      <option value="SIM" class="text-secondary">SIM</option>
                      <option value="NAO" class="text-secondary">NAO</option>
                    </select>
                ...
                <tr>
                  <th scope="row" class="text-primary">6</th>
                    ...
                    <td style="height: 15px;">
                      <select class="form-select text-secondary" name="dificuldadeN" id="dificuldadeI">
                        <option class="text-secondary">Selecione</option>
                        <option value="SIM" class="text-secondary">SIM</option>
                        <option value="NAO" class="text-secondary">NAO</option>
                      </select>
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-select text-secondary" name="tratamentoMN" id="tratamentoMI" onchange="verifica2(this.value)">
                      <option class="text-secondary">Selecione</option>
                      <option value="SIM" class="text-secondary">SIM</option>
                      <option value="NAO" class="text-secondary">NAO</option>
                    </select>
                ...
                <td>
                  <select class="form-select text-secondary" name="medicacaoN" id="medicacaoI" onchange="verifica3(this.value)">
                    <option class="text-secondary">Selecione</option>
                    <option value="SIM" class="text-secondary">SIM</option>
                    <option value="NAO" class="text-secondary">NAO</option>
                  </select>
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-select text-secondary" name="vacinaN" id="vacinaI">
                      <option class="text-secondary">Selecione</option>
                      <option value="SIM" class="text-secondary">SIM</option>
                      <option value="NAO" class="text-secondary">NAO</option>
                    </select>
                ...
                <tr>
                  ...
                  <td>
                  <select class="form-select text-secondary" name="acompanhadoN" id="acompanhadoI">
                    <option class="text-secondary">Selecione</option>
                    <option value="SIM" class="text-secondary">SIM</option>
                    <option value="NAO" class="text-secondary">NAO</option>
                  </select>
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-select text-secondary" name="emergencia" id="emergencia">
                      <option class="text-secondary">Selecione</option>
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-select text-secondary" name="informacaoN" id="informacaoI" onchange="verifica4(this.value)">
                      <option class="text-secondary">Selecione</option>
                      <option value="SIM" class="text-secondary">SIM</option>
                      <option value="NAO" class="text-secondary">NAO</option>
                    </select>
