      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><i class="bi bi-bar-chart-fill icon-color"></i><a href="graph.php" class="link-offset-2 link-underline link-underline-opacity-0 custom-padding-left text-secondary">Relatório Socioeconômicos</a></li>
            <li class="list-group-item"><i class="bi bi-activity icon-color"></i><a href="#" class="link-offset-2 link-underline link-underline-opacity-0 custom-padding-left text-secondary">Relatório de Saúde</a></li>
