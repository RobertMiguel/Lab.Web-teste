...
$sql = "UPDATE Saude SET alergiasInpN = NULL WHERE alergiasInpN = ''";
...
$sql1 = "UPDATE Saude SET restAlInpN = NULL WHERE restAlInpN = ''";
...
$sql2 = "UPDATE Saude SET tratamentoMInN = NULL WHERE tratamentoMInN = ''";
...
$sql3 = "UPDATE Saude SET medicacaoInpN = NULL WHERE medicacaoInpN = ''";
...
$sql4 = "UPDATE Saude SET informacaoInpN = NULL WHERE informacaoInpN = ''";
